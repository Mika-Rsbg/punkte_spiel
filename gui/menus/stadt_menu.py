...
class StadtMenu:
    def __init__(self, parent):
        """Erstellt das Stadt-Menü als Toplevel-Fenster.
        Args:
            parent (tk.Tk | tk.Toplevel): Das Elternfenster, in dem dieses Menü geöffnet wird."""
        self.window = tk.Toplevel(parent)
        self.window.title("Stadt Menu")
        self.window.geometry("300x200")

        # Widgets hinzufügen
        label = tk.Label(self.window, text="Stadt Optionen")
        label.pack(pady=10)
    ...
    def upgrade_dorf(self):
        print("Stadt upgraden!")  # Hier kannst du Logik für Upgrades hinzufügen
