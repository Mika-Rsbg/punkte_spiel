def resize_window(root):
    """Past die Größe eines Fenster auf die Größe an die benötigt wird um
    allen Inhalt dar zu stellen.

    Args:
        window (tk.Tk | tk.Toplevel): Fenster auf dem die Ändernungen
                                      vorgenommen werden.
    """
...
def update_widgets(labels):
    ...
    Args:
        labels (object): Object auf dem die jeweilige `update()`
